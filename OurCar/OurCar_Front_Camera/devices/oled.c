...
{ 
	...
	if(flag==1)
	{
		...
		sprintf(str,"%2.1f",X_temp);
		OLED_Print(81,4,(uint8_t*)str);	
		sprintf(str,"%-2d",Beacon_cnt);
		OLED_Print(0,6,(uint8_t*)str);
		sprintf(str,"%2.2f",S_temp);
		OLED_Print(81,6,(uint8_t*)str);					
		sprintf(str,"%4.1fV",voltage);
		OLED_Print(25,6,(uint8_t*)str);
	}
}
