...
#include "stdint.h"
#define CAN_TX_MB    12
#define CAN_TX_ID    0x02      //发送ID
#define CAN_RX_ID    0x01      //接收ID

#define Speed_ID     0x01//发送接收控速信息
#define Obstacle_ID  0x02//发送障碍信息
#define X_Thre_ID    0x03//发送计算的X_Thre
#define R_Speed_ID   0x04//发送采集的实时速度
#define distance_ID  0x05//发送积分的里程长度
