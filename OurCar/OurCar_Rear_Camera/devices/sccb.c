...
{
    GPIO_QuickInit(HW_GPIOA, SCCB_SCL, kGPIO_Mode_OOD); //初始化SCL
	  PORT_PinPullConfig(HW_GPIOA, SCCB_SCL, kPullUp);
	  PORT_PinOpenDrainConfig(HW_GPIOA, SCCB_SCL, ENABLE);
    GPIO_QuickInit(HW_GPIOA, SCCB_SDA, kGPIO_Mode_OOD); //初始化SDA
	  PORT_PinPullConfig(HW_GPIOA, SCCB_SDA, kPullUp);
	  PORT_PinOpenDrainConfig(HW_GPIOA, SCCB_SDA, ENABLE);
    GPIO_WriteBit(HW_GPIOA, SCCB_SCL, 1);
	  GPIO_WriteBit(HW_GPIOA, SCCB_SDA, 1);
}
